...
exports.getWithFilters = [async function (req, res) {
    ...
    try {
        ...
        switch (role) {
            case USER_ROLE_SHIPPER:
                const shipperServiceUrl = serviceEndpointTemplate.replace('@port', process.env.SHIPPER_SERVICE_PORT).replace('@role', USER_ROLE_SHIPPER)
